...
aws secretsmanager list-secrets --query "SecretList[?starts_with(Name, 'some_prefix_string')].Name" --output json

# Delete secret with no recovery period
aws secretsmanager delete-secret --secret-id some_secret --force-delete-without-recovery