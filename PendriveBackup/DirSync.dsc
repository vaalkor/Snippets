...
<dirsyncpro logfile="">
  <meta program="DirSync Pro 1.53" os="Windows 10-10.0-amd64" java="1.8.0_271-Oracle Corporation" />
  <job name="Drive 1" enabled="true" src="G:\" dst="I:\" syncMode="ABCustom" recursive="true" verify="false" realtimeSync="false" realtimeSyncOnStart="true" realtimeDelayValue="60" logfile="" compareMode="CompareFileSizesDates" copyAll="false" copyLarger="false" copyLargerAndModified="false" copyModified="true" copyNew="true" delFiles="false" delDirs="false" delExcludedFilesA="false" delExcludedDirsA="false" delExcludedFilesB="false" delExcludedDirsB="false" syncConflictResolutionMode="CopySource" backups="0" backupInline="true" backupDir="" timestampWriteBack="false" ignoreDaylightSavingGarnularity="false" syncDirTimeStamp="false" granularity="0" symLinkMode="SkipSymLinks" preserveDOSAttributes="false" preservePOSIXFilePermissions="false" preservePOSIXFileOwnership="false" overrideReadOnly="false">
    ...
    <filter type="ByPattern" action="Exclude" patternType="File" pattern="DirSync.ps1" regularExpression="false" />
    <filter type="ByPattern" action="Exclude" patternType="File" pattern="DirSyncSourceDrive" regularExpression="false" />
    <filter type="ByPattern" action="Exclude" patternType="File" pattern="DirSync.bat" regularExpression="false" />
    <filter type="ByPattern" action="Exclude" patternType="File" pattern="DirSync.dsc" regularExpression="false" />
  </job>
  <job name="Drive 2" enabled="true" src="G:\" dst="J:\" syncMode="ABCustom" recursive="true" verify="false" realtimeSync="false" realtimeSyncOnStart="true" realtimeDelayValue="60" logfile="" compareMode="CompareFileSizesDates" copyAll="false" copyLarger="false" copyLargerAndModified="false" copyModified="true" copyNew="true" delFiles="false" delDirs="false" delExcludedFilesA="false" delExcludedDirsA="false" delExcludedFilesB="false" delExcludedDirsB="false" syncConflictResolutionMode="CopySource" backups="0" backupInline="true" backupDir="" timestampWriteBack="false" ignoreDaylightSavingGarnularity="false" syncDirTimeStamp="false" granularity="0" symLinkMode="SkipSymLinks" preserveDOSAttributes="false" preservePOSIXFilePermissions="false" preservePOSIXFileOwnership="false" overrideReadOnly="false">
    <filter type="ByPattern" action="Include" patternType="File" pattern="*" regularExpression="false" />
    <filter type="ByPattern" action="Include" patternType="Directory" pattern="*" regularExpression="false" />
    <filter type="ByPattern" action="Exclude" patternType="File" pattern="DirSync.ps1" regularExpression="false" />
    <filter type="ByPattern" action="Exclude" patternType="File" pattern="DirSyncSourceDrive" regularExpression="false" />
  ...
  <job name="Drive 3" enabled="true" src="G:\" dst="K:\" syncMode="ABCustom" recursive="true" verify="false" realtimeSync="false" realtimeSyncOnStart="true" realtimeDelayValue="60" logfile="" compareMode="CompareFileSizesDates" copyAll="false" copyLarger="false" copyLargerAndModified="false" copyModified="true" copyNew="true" delFiles="false" delDirs="false" delExcludedFilesA="false" delExcludedDirsA="false" delExcludedFilesB="false" delExcludedDirsB="false" syncConflictResolutionMode="CopySource" backups="0" backupInline="true" backupDir="" timestampWriteBack="false" ignoreDaylightSavingGarnularity="false" syncDirTimeStamp="false" granularity="0" symLinkMode="SkipSymLinks" preserveDOSAttributes="false" preservePOSIXFilePermissions="false" preservePOSIXFileOwnership="false" overrideReadOnly="false">
    <filter type="ByPattern" action="Include" patternType="File" pattern="*" regularExpression="false" />
    <filter type="ByPattern" action="Include" patternType="Directory" pattern="*" regularExpression="false" />
    <filter type="ByPattern" action="Exclude" patternType="File" pattern="DirSync.ps1" regularExpression="false" />
    <filter type="ByPattern" action="Exclude" patternType="File" pattern="DirSyncSourceDrive" regularExpression="false" />
  ...
  <job name="Drive 4" enabled="true" src="G:\" dst="L:\" syncMode="ABCustom" recursive="true" verify="false" realtimeSync="false" realtimeSyncOnStart="true" realtimeDelayValue="60" logfile="" compareMode="CompareFileSizesDates" copyAll="false" copyLarger="false" copyLargerAndModified="false" copyModified="true" copyNew="true" delFiles="false" delDirs="false" delExcludedFilesA="false" delExcludedDirsA="false" delExcludedFilesB="false" delExcludedDirsB="false" syncConflictResolutionMode="CopySource" backups="0" backupInline="true" backupDir="" timestampWriteBack="false" ignoreDaylightSavingGarnularity="false" syncDirTimeStamp="false" granularity="0" symLinkMode="SkipSymLinks" preserveDOSAttributes="false" preservePOSIXFilePermissions="false" preservePOSIXFileOwnership="false" overrideReadOnly="false">
    <filter type="ByPattern" action="Include" patternType="File" pattern="*" regularExpression="false" />
    <filter type="ByPattern" action="Include" patternType="Directory" pattern="*" regularExpression="false" />
    <filter type="ByPattern" action="Exclude" patternType="File" pattern="DirSync.ps1" regularExpression="false" />
    <filter type="ByPattern" action="Exclude" patternType="File" pattern="DirSyncSourceDrive" regularExpression="false" />
